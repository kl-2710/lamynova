"use strict";
console.log('main.js loaded and executing!'); // Dòng này sẽ chạy ngay lập tức khi script được tải
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (avatarButton && userDropdown) {
        console.log('Avatar button and dropdown found. Attaching event listener.');
        avatarButton.addEventListener('click', function() {
            console.log('Avatar button clicked!');
            userDropdown.classList.toggle('hidden');
            console.log('Dropdown hidden status toggled. Current classes:', userDropdown.classList.value);
        });
        ...
        console.log('Avatar button or dropdown not found on DOMContentLoaded.');
    }
});